...
function main() {
    ...
    matrices.forEach((mat, ndx) => {
        ...
        m4.zRotate(mat, 3 * (0.1 + 0.1 * ndx), mat);
        //构造matrixData 
        matrixDataV0[ndx*4]=mat[0];
        matrixDataV0[ndx*4+1]=mat[4];
        matrixDataV0[ndx*4+2]=mat[8];
        matrixDataV0[ndx*4+3]=mat[12];
        matrixDataV1[ndx*4]=mat[1];
        matrixDataV1[ndx*4+1]=mat[5];
        matrixDataV1[ndx*4+2]=mat[9];
        matrixDataV1[ndx*4+3]=mat[13];
        matrixDataV2[ndx*4]=mat[2];
        matrixDataV2[ndx*4+1]=mat[6];
        matrixDataV2[ndx*4+2]=mat[10];
        matrixDataV2[ndx*4+3]=mat[14];
        matrixDataV3[ndx*4]=mat[3];
        matrixDataV3[ndx*4+1]=mat[7];
        matrixDataV3[ndx*4+2]=mat[11];
        matrixDataV3[ndx*4+3]=mat[15];
    });
    ...
    gl.bufferData(gl.ARRAY_BUFFER, matrixDataV0, gl.STATIC_DRAW);//
    ...
    gl.bufferData(gl.ARRAY_BUFFER, matrixDataV1, gl.STATIC_DRAW);
    gl.bindBuffer(gl.ARRAY_BUFFER, null);
    ...
    gl.bufferData(gl.ARRAY_BUFFER, matrixDataV2, gl.STATIC_DRAW);
    gl.bindBuffer(gl.ARRAY_BUFFER, null);
    ...
    gl.bufferData(gl.ARRAY_BUFFER, matrixDataV3, gl.STATIC_DRAW);
    gl.bindBuffer(gl.ARRAY_BUFFER, null);
    ...
    //gl.bufferSubData(gl.ARRAY_BUFFER, 0, matrixDataV0);
        //gl.bufferData(gl.ARRAY_BUFFER, matrixDataV0, gl.STATIC_DRAW);//使用bufferData也可以
