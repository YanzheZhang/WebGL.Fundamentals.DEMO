...
function main() {
    ...
    //var fudgeLocation = gl.getUniformLocation(program, "u_fudgeFactor");//没有获取到也不报错！
    ...
    function drawScene() {
        ...
        // Set the fudgeFactor
        //gl.uniform1f(fudgeLocation, fudgeFactor);//如果获取gl.getUniformLocation(program, "u_fudgeFactor");不注释也不报错  
