...
function main() {
    ...
    moonNode.localMatrix = m4.scaling(0.5, 0.5, 0.5);
    moonNode.drawInfo = {
        uniforms: {
    ...
    function drawScene(time) {
        ...
        // 更新每个物体的局部矩阵
        m4.multiply(earthOrbitNode.localMatrix, m4.yRotation(0.01), earthOrbitNode.localMatrix);
        m4.multiply(moonOrbitNode.localMatrix, m4.yRotation(0.01), moonOrbitNode.localMatrix);
        // 旋转地球
